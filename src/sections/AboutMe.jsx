    ...
    <section id="about" className="p-5 container mx-auto">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-5 section-container">
        ...
        <div className="w-full sm:w-3/5 pt-10">
          ...
          <p className="text-black text-md md:text-lg justify-around pb-5 text-justify">
            {about_me[0].content}
          </p>
          ...
          <div className="flex">
            ...
            <div className="flex justify-center items-center mx-auto sm:mx-0 mt-5 gap-10">
              {about_me[0].socialIcons.map((social, i) => (
                <a
                  // to="https://www.facebook.com/profile.php?id=100084295832172"
                  // to="/"
                  href={social.link}
                  // to={social.link}
                  target="_blank"
                  key={i}
                  className="w-10 h-10 text-white bg-img-gradient rounded-2xl p-2 text-2xl font-bold hover:scale-105 transition-all duration-300 ease-in-out hover:rotate-6 cursor-pointer"
                >
                  {<social.icon />}
                </a>
              ))}
